...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container">
                    <h1 class="mt-4">전시관 추가</h1>
                    <form action="${path}/addGallery.ad" method="post">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="galleryPlace" name="galleryPlace" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="galleryInfo">설명</label>
                            <textarea class="form-control" id="galleryInfo" name="galleryInfo" rows="3" required></textarea>
                        </div>
                        <div class="form-group mb-3">
                            <label for="galleryType">종류</label>
                            <select class="form-control" id="galleryType" name="galleryType" required>
                                <option value="소형관">소형관</option>
                                <option value="중형관">중형관</option>
                                <option value="대형관">대형관</option>
                            </select>
                        </div>
