...
<body>
    ...
    <script>
        $(function(){
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $("#content-area").append(createDisplayElement(result.display));
                    $("#content-area").append(createNoticeElement(result.notice));
                    $("#content-area").append(createArtistElement(result.artist));
        ...
        function createDisplayElement(display) {
            ...
            displayName.innerText = display.displayName;
            ...
            displayContent.innerText = display.displayContent;
        ...
        function createNoticeElement(notice) {
            ...
            noticeContent.innerText = notice.noticeContent;
        ...
        function createArtistElement(artist) {
            ...
            // var $ee = $("<div class=card>").append(displayImg).append(displayName).append(displayDuration).append(displayContent).append(displayGallery);
            var $ee = $("<div class=card>").append(artistImg).append(artistNickName).append(artistIntroduce);
            var $e = $("<div class=section>").append("<h2>작가</h2>").append($ee);
