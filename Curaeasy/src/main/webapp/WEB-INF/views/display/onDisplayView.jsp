        ...
        <div class="exhibition-list">
            <c:forEach var="exhibition" items="${ list }">
                <div class="exhibition-item">
                	<div id="luv" style="text-align: right"><button name="${ exhibition.displayNo }" class="btn btn-outline-dark" onclick="likeCheck(this);">❤ ${ exhibition.likeCount }</button></div>
