		...
		<div class="content">
			<div class="content-header">
				...
				<c:choose>
					...
					<c:when test="${ requestScope.ticket > 0}">
						<form action="reviewEnrollForm.re">
						<button id="ReviewBtn" type="submit" style="float: right;">후기작성하기</button>
						</form>
					</c:when>
					<c:otherwise>
			...
			<div class="search-box" style="float: right">
				...
				<form action="review.do" id="SearchFunction">
					<select name="category" id="category" class="form-control">
						...
						placeholder="검색어를 입력하세요." value="${ requestScope.search }"
						style="display: inline;" class="form-control">
						...
						<c:choose>
							<c:when test="${ requestScope.pi.currentPage ne p }">
								<li class="page-item"><a
									href="review.do?cpage=${ p }&category=${ requestScope.category }&search=${ requestScope.search }">
										${ p } </a></li>
							</c:when>
							<c:otherwise>
